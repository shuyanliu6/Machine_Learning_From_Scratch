...
class DecisionTrees:
    ...
    def __init__(self, min_samples_split=2, max_depth=100, n_features=None, root=None, task='classification'):
    ...
    def fit(self, X, y):
        # make sure features does not exceed the dataset features
    ...
    def _best_split(self, X, y, feature_idxs):
        ...
        for feat_idx in feature_idxs:
            ...
            for thr in thresholds:
                #calculate the information gain based on task type
    ...
    def _variance_reduction(self, y, X_column, threshold):
        ...
        # calculate the wieghted average variance of children
        n = len(y)
        n_l, n_r = len(left_idxs), len(right_idxs)
